 ...
 * the visitor walks past the building rather than scanning a grid.
 * Vertical editorial stack on small screens and for reduced motion.
 */
    ...
    >
      ...
      >
        <div className="flex max-w-md flex-col gap-6 lg:w-[32vw] lg:shrink-0">
          ...
          <h2 className="font-serif display-lg text-balance">Form with restraint</h2>
          <p className="lede">
            Geometry that feels inevitable. Materials that age with grace. Walk past the facade —
            slowly.
          </p>
        </div>
