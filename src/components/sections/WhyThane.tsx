...
import { thanePillars } from "@/lib/content";
import { images } from "@/lib/images";

export function WhyThane() {
  return (
    <section id="thane" aria-label="Why Thane" className="bg-ivory">
      {/* Image dominates — 90% of the story */}
      <div className="relative left-1/2 w-screen -translate-x-1/2">
        <div className="relative h-[min(92vh,56rem)] w-full">
          ...
          />
          {/* Localised dark scrim behind text only — no white wash */}
          ...
          <div className="absolute inset-x-0 bottom-0 px-[var(--section-pad-x)] pb-14 md:pb-20">
            <Reveal>
              <p className="eyebrow text-champagne/70">Location</p>
              <h2 className="mt-5 font-serif display-lg text-ivory text-balance max-w-2xl">
                Why Thane
              </h2>
              <p className="mt-6 max-w-md text-lg leading-relaxed text-champagne/85">
                Close enough to everything that matters. Far enough that your evenings belong to you
                again.
              </p>
            </Reveal>
          </div>
      ...
      {/* Pillars breathe on ivory — separate chapter, not competing with image */}
